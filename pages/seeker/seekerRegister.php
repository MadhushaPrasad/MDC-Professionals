            ...
            <div class="container">
                ...
                <div class="form">
                    <form action="ProviderRegister.php" method="post">
                        <input type="file" name="Image" value="Image" id="profile-image" placeholder="Choose a Profile image" required="" capture>
                        ...
                        <input type="text" name="Date_Of_Birth" placeholder="Date_Of_Birth" onfocus="(this.type='date')" required>
